...
export default function PendingVerificationPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 p-4 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-teal-500/5 dark:bg-teal-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-md w-full bg-white dark:bg-slate-800 rounded-3xl shadow-2xl p-8 sm:p-10 text-center border border-gray-100 dark:border-slate-700">
        ...
        <div className="relative w-24 h-24 mx-auto mb-8 flex items-center justify-center">
          <div className="absolute inset-0 bg-teal-100 dark:bg-teal-900/30 rounded-full animate-pulse opacity-75" />
          <div className="relative z-10 w-full h-full bg-teal-100 dark:bg-teal-900/50 rounded-full flex items-center justify-center border-4 border-white dark:border-slate-800 shadow-lg">
            <Clock className="w-10 h-10 text-teal-600 dark:text-teal-500" />
          </div>
        </div>
        ...
        <p className="text-gray-500 dark:text-slate-400 mb-10 leading-relaxed">
          Your credentials (including National ID and professional certificates) are currently being reviewed by our administration team. You will be able to practice your activity as a consultant as soon as your account is approved.
        </p>
        ...
        <div className="mt-6 text-sm text-gray-400 dark:text-slate-500 font-semibold uppercase tracking-wider">
          Under Review
        </div>
      </div>
    </div>
