    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-0 right-0 sm:bottom-24 sm:right-6 z-[9999] w-full sm:w-96 h-[100dvh] sm:h-[500px] sm:max-h-[calc(100vh-100px)] flex flex-col bg-white dark:bg-slate-900 sm:rounded-2xl shadow-2xl border-t sm:border border-gray-200 dark:border-slate-800 overflow-hidden"
        >
          {/* Header */}
